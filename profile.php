...
.header-main mobile-hide .container {
    max-width: 1200px;
    margin: 20px; 
}
...
.link:hover {
    color: #794afa; /* Adjust the hover text color as needed */
}


/* Styling for the profile heading */
.profile-heading {
    color: #000;
    font-size: 24px;
}
    ...
    <div class="header">
        <div class="upper-header">
            <div class="upper_header_main">
                <div class="part1">
                <a href="../user area/footer/blog.html">
                      <h3 class="part1-contant">
                        Blog
                      </h3>
                    </a>
                    <a href="../user area/display_all.php">
                      <h3 class="part1-contant">
                        Shop
                      </h3>
                    </a>
                    <a href="../user area/compear_product_details.php">
                      <h3 class="part1-contant">
                        Compear
                      </h3>
                    </a>
