...
<body>
  <div class="sidebar close">
    <div class="logo-details">
        <img src="../user_area/icons/Loomlux-White.png" alt="">
    ...
    <ul class="nav-links">
        <li>
            ...
            <ul class="sub-menu">
              <li><a class="link_name" href="#">Insert Brands and Category</a></li>
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><button><a href="admin.php?customer_details">Customer Details</a></button></li>
          <li><button><a href="admin.php?shop_details">Seller Details</a></button></li>
        </ul>
      </li>
      <li>
        <div class="iocn-link">
        ...
        <ul class="sub-menu">
          ...
          <li><button><a href="admin.php?admin_register">Register Admin</a></button></li>
          <li><button><a href="admin.php?shop_register">Register Seller</a></button></li>
        </ul>
      </li>
      <li>
        <a href="admin.php?list_orders">
          <i class='bx bx-history'></i>
          <span class="link_name">View Order History</span>
        </a>
        <ul class="sub-menu blank">
          <li><button><a class="link_name" href="admin.php?list_orders">View Order History</a></button></li>
        </ul>
      </li>
      <li>
...
?>
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <a href="" class="nav-link" style="text-decoration:none; font-weight:bold; color:black"> Welcome Admin</a>
    </div>
    <div class="adminhead">
      <h2>ADMIN PAGE</h2>
    </div>
